import userBOESummaryTable from "@/src/hooks/useBOE.tsx/useBOESummary";
...
const Summary = ({ job_id }: { job_id: string }) => {
  const { isLoading, isError, data, table, total_pages, page, handlePage, total_data } = userBOESummaryTable(job_id);
