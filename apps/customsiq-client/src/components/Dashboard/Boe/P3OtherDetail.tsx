...
import useP3OtherDetails from "@/src/hooks/useBOE.tsx/useP3OtherDetails";
...
const P3OtherDetails = ({ job_id }: { job_id: string }) => {
  const { isLoading, isError, data, table, total_pages, page, handlePage, total_data } = useP3OtherDetails(job_id);
  return (
    <div>
      {isLoading && <Loading />}
