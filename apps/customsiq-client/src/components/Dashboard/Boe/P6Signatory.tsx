...
import useP6Signatory from "@/src/hooks/useBOE.tsx/useP6Signatory";
import Loading from "@/src/ui/Loading";
import { TableContainer } from "prosperoiq-table";
import { useSearchParams } from "next/navigation";

const P6Signatory = ({ job_id }: { job_id: string }) => {
  const { isLoading, isError, data, table, total_pages, page, handlePage, total_data } = useP6Signatory(job_id);
  return (
    <div>
      {isLoading && <Loading />}
