...
import useHSNTable from "@/src/hooks/useMaster/useHSN";
...
import {
  useExportReportFilter,
  useMasterReportFilter,
...
const HSN = ({ user_id, download_func }: { user_id: string; download_func: () => Promise<void> }) => {
      ...
      <div className="flex mt-4">
        ...
        <AnimatePresence>
          {showFilter && (
            ...
            >
              <div className="overflow-auto h-[calc(100vh-250px)] rounded-sm py-3 px-4 bg-white w-65">
                {filter && (
                  <FilterPanel
                    value={filters}
        ...
        <motion.div   className="flex-1 overflow-auto ">
          ...
          {!isError && !isLoading && !!data.length && (
            <div className="overflow-x-auto  h-[calc(100vh-310px)]   ">
