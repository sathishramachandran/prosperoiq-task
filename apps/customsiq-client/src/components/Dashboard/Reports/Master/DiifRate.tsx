...
import useDifRateTable from "@/src/hooks/useMaster/useDifRate";


const DiffRate = ({ user_id, download_func }: { user_id: string; download_func: () => Promise<void> }) => {
  const {
    isLoading,
    isError,
    data,
