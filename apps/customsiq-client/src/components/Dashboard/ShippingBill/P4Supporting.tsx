import useP4SupportingTable from "@/src/hooks/useSE/useP4Supporting";
import Loading from "@/src/ui/Loading";
import { TableContainer } from "prosperoiq-table";

const P4Supporting = ({ job_id }: { job_id: string }) => {
  const {
    isLoading,
    isError,
    data,
