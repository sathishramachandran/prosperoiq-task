...
const userSingleWindowTable = (user_id: string, report_name: string) => {
    ...
    return [
...

      {
        ...
        cell: (info: any) => {
          return (
            <ViewDetails>
              <button className="rounded-sm cursor-pointer bg-green-600 text-white px-2 py-1">
                View Invoices
              </button>
            </ViewDetails>
          );
...
export default userSingleWindowTable;
