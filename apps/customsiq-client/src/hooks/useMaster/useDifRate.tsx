...
const useDifRateTable = (user_id: string, format: string) => {
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => {
    return [
      ...
      {
        header: "Description [MASTER]",
        accessorKey: "Description [MASTER]",
        cell: (info: any) => <p>{info.getValue() || "-"}</p>,
      },
      {
        header: "CTH [MASTER]",
      ...
      {
        header: "BCD % [MASTER]",
        accessorKey: "BCD % [MASTER]",
        cell: (info: any) => <p>{info.getValue() ?? "-"}</p>,
      },
      {
        header: "SWS % [MASTER]",
        accessorKey: "SWS % [MASTER]",
        cell: (info: any) => <p>{info.getValue() ?? "-"}</p>,
      },
      {
        header: "IGST % [MASTER]",
        accessorKey: "IGST % [MASTER]",
        cell: (info: any) => <p>{info.getValue() ?? "-"}</p>,
      },
      {
        header: "CTH [BOE]",
      ...
      {
        header: "Description [BOE]",
        accessorKey: "Description [BOE]",
        cell: (info: any) => <p>{info.getValue() || "-"}</p>,
      },
      {
        header: "BCD % [BOE]",
...
export default useDifRateTable;
