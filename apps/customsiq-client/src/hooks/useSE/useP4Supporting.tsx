...
const useP4SupportingTable = (id: string) => {
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => {
    return [
      ...
      {
        header: "Doc Type Cd",
        accessorKey: "Doc Type Cd",
        cell: (info: any) => <div>{info.getValue() || "-"}</div>,
      },
      {
        header: "Icegate ID",
        accessorKey: "Icegate ID",
        cell: (info: any) => <div>{info.getValue() || "-"}</div>,
      },
      {
        header: "IRN",
      ...
      {
        header: "Party Cd",
        accessorKey: "Party Cd",
        cell: (info: any) => <div>{info.getValue() || "-"}</div>,
      },
      {
        header: "Issue Place",
        accessorKey: "Issue Place",
        cell: (info: any) => <div>{info.getValue() || "-"}</div>,
      },
      {
        header: "Issue Dt",
        accessorKey: "Issue Dt",
        cell: (info: any) => <div>{info.getValue() || "-"}</div>,
      },
      {
        header: "Exp Dt",
...
export default useP4SupportingTable;
