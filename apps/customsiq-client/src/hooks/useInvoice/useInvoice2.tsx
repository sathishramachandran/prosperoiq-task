...
const useInvoice2Table = (user_id: string, invoice_no: string) => {
  ...
  const {
    ...
    isPending,
    isError,
  } = useInvoiceReportsMain(user_id, invoice_no, page, limit);
...
export default useInvoice2Table;
