...
const useP4SchemaTable = (id: string) => {
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => {
    return [
      ...
      {
        header: "Scheme Notn",
        accessorKey: "Scheme Notn",
        cell: (i: any) => <p>{i.getValue() || "-"}</p>,
      },
      {
        header: "Sch Nsno",
        accessorKey: "Sch Nsno",
        cell: (i: any) => <p>{i.getValue() || "-"}</p>,
      },
      {
        header: "BCD Rate",
      ...
      {
        header: "BCD Amt Fg",
        accessorKey: "BCD Amt Fg",
        cell: (i: any) => <p>{i.getValue()}</p>,
      },
      {
        header: "Oth Amt Fg",
        accessorKey: "Oth Amt Fg",
        cell: (i: any) => <p>{i.getValue() }</p>,
      },
    ];
...
export default useP4SchemaTable;
