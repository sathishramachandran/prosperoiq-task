...
const useP6DeclarationTable = (id: string) => {
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => {
    return [
      ...
      {
        header: "Declaration Details",
        accessorKey: "Declaration Details",
        cell: (i: any) => (
  ...
  return {
    table: useReactTable({
      ...
      initialState: {
        columnOrder: ["select-col", "be_no", "Declaration Details"],
      },
      getRowId: (row) => row.id,
...
export default useP6DeclarationTable;
