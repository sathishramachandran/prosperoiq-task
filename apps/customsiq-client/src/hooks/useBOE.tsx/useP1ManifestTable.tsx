...
const userP1ManifestTable = (id: string) => {
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => {
    return [
      ...
      {
        header: "Igm Date",
        accessorKey: "Igm Date",
        cell: (i: any) => <p>{i.getValue() || "-"}</p>,
      },
      {
        header: "Inw Date",
        accessorKey: "Inw Date",
        cell: (i: any) => <p>{i.getValue() || "-"}</p>,
      },
      {
        header: "Gigmno",
...
export default userP1ManifestTable;
